...
export default async function PrinciplesPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <article className="prose-headings:font-bold prose-headings:tracking-tight [&_a]:underline [&_a]:underline-offset-2 [&_h1]:text-3xl [&_h2]:mt-8 [&_h2]:text-xl [&_li]:leading-relaxed [&_li]:text-ink-soft [&_p]:mt-3 [&_p]:leading-relaxed [&_p]:text-ink-soft [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5">
