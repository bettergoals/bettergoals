...
| [0005](0005-the-canvas-holds-the-ssh-pattern.md) | **The canvas holds the pattern `/okrs` teaches** — both coaches are handed the SSH OKR pattern, ⑤ holds the set of leading indicators rather than one measure, and any box already answered can be reopened | Decided, 15 Sep 2026 | Both coaches, and the canvas |
